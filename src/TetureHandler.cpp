...
void TextureHandler::image_init(int width, int height){
...
void TextureHandler::image_done() {
...
void TextureHandler::image_read(char *filename) {
    ...
    /*
      Od podataka iz drugog zaglavlja koristimo samo informacije o dimenzijama slike.
    */
